...
export default function BenchmarkStats({ benchmarks }: BenchmarkStatsProps) {
  ...
  // Open modal to view 3D structure
  ...
  return (
    <div className="space-y-8">
      ...
      {/* Modal for 3D Viewer */}
      <Modal isOpen={modalIsOpen} onRequestClose={closeModal} contentLabel="3D Structure Viewer">
        <h2 className="text-xl font-semibold mb-4">3D Structure for {selectedBenchmark?.proteinName}</h2>
        {selectedBenchmark && (
